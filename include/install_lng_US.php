 ...
 * @version    7e0ccc855ea5b6d0fdfbb32aa8d5341656dc9713, v145 (xcart_4_7_7), 2017-01-25 11:47:53, install_lng_US.php, aim
...
$install_languages["US"] = array (
    ...
    "contact_for_help_link" => "<a href=\"http://www.x-cart.com/contact_us.html\" target=\"_blank\">Contact X-Cart for help</a>",
    ...
    "thank_you_for_contact" => "Thank you for contacting us.<br /> Someone from our staff will contact you at the earliest opportunity.<br /><br />You can find more information about X-Cart software at <a href=\"http://www.x-cart.com/faq.html\" target=\"_blank\">X-Cart: Frequently asked questions</a> page.<br />Also, you can find X-Cart knowledge base at <a href=\"http://help.x-cart.com\" target=\"_blank\">http://help.x-cart.com</a>",
    ...
    "copyright_text" => "&copy; 2001-present <a href=\"http://www.x-cart.com\">X-Cart.com</a><br />&copy; 2001-present Qualiteam software Ltd &lt;info@x-cart.com&gt;",
    ...
    "mod_cfg_install_db" => "Preparing to install X-Cart",
    ...
    "techrep_intro" => '<p>Please use below form to send installation errors report to us and we will contact you to help as soon as we can.</p><p>You can find more information about X-Cart software at <a href="http://help.x-cart.com" target="_blank">http://help.x-cart.com</a> page.</p>',
    ...
    "view_details" => "View detailed report",
    "bool_off" => "Disabled",
    "bool_on" => "Enabled",
    ...
    "dep_gd_descr" => '<p>GD library 2.0 or later is required for the following X-Cart features:</p><ul><li>Automatic product thumbnail generation.</li><li>Antibot \'Image Verification\' module.</li><li>Cache generation for \'Detailed Product Images\' module.</li></ul>',
    ...
    "permissions_descr" => '<p>Here is a list of files/directories that failed permissions check:</p>{{value}}<p>You can find more information about X-Cart software at <a href="http://help.x-cart.com/index.php?title=X-Cart:FAQs" target="_blank">X-Cart: Frequently asked questions</a> page.</p>',
    "non_critical_permissions_descr" => '<p>Here is a list of files/directories that failed permissions check:</p>{{value}}<p>You can find more information about X-Cart software at <a href="http://help.x-cart.com/index.php?title=X-Cart:FAQs" target="_blank">X-Cart: Frequently asked questions</a> page.</p>',
    ...
    "install_mysqlpass_alert" => "Empty MySQL password is not allowed due to security reasons",
    ...
    "install_enable_cloud_search" => "<b>Enable CloudSearch</b><br />CloudSearch is a SaaS solution that integrates with X-Cart to enable dynamic, real-time product search in an X-Cart based store.",
    ...
    'install_security_profile' => '<strong>Security profile</strong><br />The "Live store" profile has several security restrictions to protect sensitive data from unauthorized access.<br />Please refer to the <a href="http://help.x-cart.com/index.php?title=X-Cart:Security_Profiles" target="_blank">user manual</a> for details.<br />',
    'install_security_profile_live' => 'Live store',
    'install_security_profile_test' => 'Evaluation/Playground',
    ...
    "importing_modules_data" => "Importing modules...",
    ...
    "generate_snapshots_tooltip" => 'The generation of a system fingerprint is a lengthy process, and on some servers it may be terminated early. In this case, the installation of the store will not be completed. You can generate a system fingerprint from the admin area after the installation of the store. <a href="http://help.x-cart.com/index.php?title=X-Cart:System_Fingerprints" target="_blank">X-Cart:System Fingerprints</a>',
    ...
    "evaluation_notice" => 'Your X-Cart GoldPlus installation is licensed for evaluation purposes only. For details refer to <a href="http://www.x-cart.com/license-agreement-classic.html" target="_blank" >X-Cart license agreement.</a><br /><br />To upgrade your license please purchase <a href="http://www.x-cart.com/buy_goldplus.html" target="_blank" >X-Cart GoldPlus paid license</a> and register your copy as follows:<br /><ol><li>Make sure that no HTTP-authorization and firewall restrictions are set on incoming HTTP-connections to your X-Cart installation.</li><li>Login to your <a href="https://secure.x-cart.com/" target="_blank">private members area</a> with your username and password.</li><li>Go to <a href="https://secure.x-cart.com/customer.php?area=customer_licenses&amp;target=customer_licenses" target="_blank" >"My licenses" section.</a></li><li>Check whether the license URL is <b>{{http_location}}</b>. If it is not, follow the "Change URL" link to the right from the license URL and replace the license URL with <b>{{http_location}}</b>.</li><li>Follow "Register" link to the right from the license URL.</li><li><a href="{{http_location}}/admin/general.php" target="_blank">Open</a> in order to ensure that registration was successful.</li><li>In case of any problems with purchase or registration process please <a href="http://www.x-cart.com/contact_us.html?reason=registration_problems" target="_blank" >contact us.</a></li></ol> <br />',
    ...
    "change_shop_type_manually" => "Package installer could not patch the file init.php. <b>It is strongly recommended</b> to replace the string \'\$shop_type = \"GOLD\"' with '\$shop_type = \"GOLDPLUS\"' in this file manually.",
    "post_install_permissions_notice_intro" => "Before you start using {{product}}, please restore secure permissions as advised below:",
    "post_install_permissions_notice_intro_windows" => "To ensure the security of your server, it is recommended that you disable write permission for the user {{user}} to all directories and files (recursively) excluding var, skin1, catalog, files.<br /><br />Setup the necessary file permissions using a suitable facility supplied by your hosting provider. For instructions on how to use a particular facility, consult the documentation for the facility or contact your hosting team.<br /><br /> An overview of file permissions in Windows is available at:<br /><ul><li><a href='http://support.microsoft.com/kb/131780'>http://support.microsoft.com/kb/131780</a></li><li><a href='http://support.microsoft.com/kb/308419'>http://support.microsoft.com/kb/308419</a></li></ul><br />If you are not sure you can setup file permissions correctly, contact our Support team using your personal HelpDesk at <a href='https://secure.x-cart.com'>https://secure.x-cart.com</a>",
    "install_rename_success" => "Installation script install.php renamed to <b>{{install_name}}</b>.<br /><br />The file has been renamed to prevent unauthorized access to the {{product}} installation script install.php. In the future, if you wish to reinstall {{product}}, rename the file back to install.php first.",
...
<br />
<b>Note:</b><br />
Auth code will be used to prevent unauthorized access to {{product}} installation script install.php. If, in the future, you decide to completely re-install {{product}} or install some {{product}} add-ons, you will be required to enter this code at the time of installation. Please be aware that this code is stored for you in include/install.php.<br />
<br />
...
',
    ...
    "xpconf_provider_note" => "( \"Products\" :: \"Product Wizard\" )",
