 ...
 * @version    cf9e608d41c40f761c6416f642a1d0094a6af214, v39 (xcart_4_7_7), 2017-01-24 09:29:34, returns.php, aim
...
if (empty($access_key)) {
    ...
    $access_key = isset($_GET['access_key']) ? $_GET['access_key'] : $access_key;

    func_setcookie('access_key', $access_key);
}
