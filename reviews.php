 ...
 * @version    cf9e608d41c40f761c6416f642a1d0094a6af214, v15 (xcart_4_7_7), 2017-01-24 09:29:34, reviews.php, aim
...
if (isset($productid)) {
    ...
    $location[] = array($product_info['product'], 'product.php?productid=' . intval($productid));
}
