 ...
 * @version    cf9e608d41c40f761c6416f642a1d0094a6af214, v61 (xcart_4_7_7), 2017-01-24 09:29:34, memberships.php, aim
...
if ($mode == 'update' && !empty($posted_data)) {
    ...
    foreach ($posted_data as $id => $v) {
        ...
        if (!empty($active_modules['POS_System'])) {
            $v = func_set_pos_operator_checkbox($v);
        }
...
// Delete memerbship(s)
    ...
    db_query("DELETE FROM $sql_tbl[category_threshold_bestsellers] WHERE ".$delete_string);
