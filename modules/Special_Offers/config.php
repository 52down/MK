 ...
 * @version    be9581a5c8bee4302a16debb9e0897116cdf6192, v47 (xcart_4_7_8), 2017-04-03 20:33:15, config.php, aim
...
$sql_tbl['order_applied_offers_sets'] = XC_TBL_PREFIX . 'order_applied_offers_sets';
$sql_tbl['order_applied_offers'] = XC_TBL_PREFIX . 'order_applied_offers';
...
if (defined('TOOLS')) {//{{{
    $tbl_demo_data['Special_Offers'] = array(
        ...
        'offers' => '',
        'offers_lng' => '',
        'order_applied_offers' => '',
        'order_applied_offers_sets' => '',
    );
    ...
    $tbl_keys['order_applied_offers.orderid test links to xcart_order_applied_offers_sets'] = array(
        'keys'         => array(
            'order_applied_offers.orderid' => 'orders.orderid',
        ),
        'fields'     => array(
            'applied_offers_setid',
        ),
    );
}//}}}
