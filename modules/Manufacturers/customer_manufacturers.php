 ...
 * @version    cf9e608d41c40f761c6416f642a1d0094a6af214, v40 (xcart_4_7_7), 2017-01-24 09:29:34, customer_manufacturers.php, aim
...
if (strpos($PHP_SELF, 'cart.php') !== FALSE)
    return;

$manufacturers_count = func_query_first_cell("SELECT COUNT(avail) FROM $sql_tbl[manufacturers] USE INDEX (avail) WHERE avail = 'Y'");
