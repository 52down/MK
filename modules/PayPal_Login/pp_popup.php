 ...
 * @version    cf9e608d41c40f761c6416f642a1d0094a6af214, v6 (xcart_4_7_7), 2017-01-24 09:29:34, pp_popup.php, aim
...
$scope = array('openid', 'email', 'profile', 'address', 'phone');

$redirectUri = func_get_securable_current_location() . '/pplogin_return.php';
$openidurl = PPOpenIdSession::getAuthorizationUrl($redirectUri, $scope , $clientId,  $apicontext);

func_header_location($openidurl);
