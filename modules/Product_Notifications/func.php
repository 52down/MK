 ...
 * @version    cf9e608d41c40f761c6416f642a1d0094a6af214, v22 (xcart_4_7_7), 2017-01-24 09:29:34, func.php, aim
...
function func_send_product_notification($notification_data) {
    ...
    // Transalte product
    $_translated_products = func_translate_products(array($product), $to_customer);
    $product = array_shift($_translated_products);
