 ...
 * @version    cf9e608d41c40f761c6416f642a1d0094a6af214, v11 (xcart_4_7_7), 2017-01-24 09:29:34, func_B.php, aim
...
function func_product_notifications_trigger_check_B($notification_data) {
    ...
    return ($product['avail'] >= max(1, $product['min_amount']) && $product['forsale'] != 'N');
}
