 ...
 * @version    571eaf023ca8b45f12e6750f9c18776cc57d2695, v67 (xcart_4_7_8), 2017-04-12 10:42:01, config.php, aim
...
if (!empty($config['Product_Options']) && $config['Product_Options']['po_use_list_price_variants'] == 'Y') {
    $variant_properties[] = 'list_price';
}
...
if (defined('IS_IMPORT')) {
    ...
    $modules_import_specification['PRODUCT_VARIANTS'] = array(
        ...
        'table'         => 'classes',
        'key_field'     => 'productid',
        'oninitexport'  => 'func_po_init_export',//remove list_price column if Po_use_list_price_variants is N
        'columns'       => array(
            'productid'     => array(
                'type'      => 'N',
                'is_key'    => true,
            ...
            'price'         => array(
                'type'      => 'P',
                'default'   => 0.00),
            'list_price'    => array( // Decimal: product market price can be disabled in func_po_init_export
                'type'      => 'P',
                'default'   => 0.00),
            'avail'         => array(
                'type'      => 'N',
...
if (!empty($include_func)) {
    ...
    if (defined('TOOLS')) {
        $tbl_demo_data['Product_Options']['variants'] = XCVariantsSQL::isVariantRow();
    }
}
?>
