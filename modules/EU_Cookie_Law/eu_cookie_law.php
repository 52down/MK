 ...
 * @version    cf9e608d41c40f761c6416f642a1d0094a6af214, v10 (xcart_4_7_7), 2017-01-24 09:29:34, eu_cookie_law.php, aim
...
if (
    ...
    if (!empty($logged_userid) && $logged_userid > 0) {
        db_query("REPLACE INTO $sql_tbl[customer_eu_cookie_accesses] set eu_cookie_access='$now/$functional_access/$other_access', userid='$logged_userid'");
    }
