{*
b9cf72503764b09e25f3db9f8c958fb857441c01, v34 (xcart_4_7_7), 2016-12-27 20:27:17, product_details.tpl, aim
...
<form name="orderform" method="post" action="cart.php" onsubmit="javascript: return FormValidation(this);" id="orderform">
  ...
  <table cellspacing="0" class="product-properties" summary="{$lng.lbl_description|escape}">
    ...
    {else}
    <tr{if $product.appearance.has_market_price and $product.appearance.market_price_discount gt 0 or $variant_list_price_no_empty} class="product-price-row"{/if}>
