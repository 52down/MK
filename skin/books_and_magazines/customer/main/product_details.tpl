{*
b9cf72503764b09e25f3db9f8c958fb857441c01, v28 (xcart_4_7_7), 2016-12-27 20:27:17, product_details.tpl, aim
  ...
  <table cellspacing="0" class="product-properties" summary="{$lng.lbl_description|escape}">
	...
	<tr>
      ...
      <div id="list_price_container">
        {$lng.lbl_market_price}: {currency value=$product.list_price tag_id="product_list_price"},
        <span class="you-save">{$lng.lbl_saving} {$you_save=$product.list_price-$product.taxed_price}{currency value=$you_save tag_id="product_list_price_abs_save"}</span>
      </div>
		{/if}
