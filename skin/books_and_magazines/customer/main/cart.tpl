{*
41562c5cfeb62cd856c8982b2d194c8a49e4f4c3, v17 (xcart_4_7_7), 2016-12-26 19:10:26, cart.tpl, aim
              ...
              <tr>
                <td class="image">
                    {if $active_modules.On_Sale}
                      {include file="modules/On_Sale/on_sale_icon.tpl" product=$product current_skin="books_and_magazines" module="cart"}
                    {else}
