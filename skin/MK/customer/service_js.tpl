...
{load_defer file="bootstrap/js/jquery.min.js" type="js"}
{load_defer file="bootstrap/js/bootstrap.min.js" type="js"}
...
{load_defer file="_includes/js/swiper.min.js" type="js"}
{load_defer file="_includes/js/main-jquery.js" type="js"}
