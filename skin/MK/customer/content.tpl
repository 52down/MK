<section class="content{if $main ne "catalog" || $current_category.category ne ""} page-content{/if} {$page_style}">
{if $top_message}
...
{*
391641586d99f626ad6a0f641684cc8772cde38a, v13 (xcart_4_7_7), 2016-12-20 14:06:51, content.tpl, aim
...
<!-- central space -->
    ...
    {else}
      ...
      {if $main ne "cart" and $main ne "checkout" and $main ne "order_message" and $main ne "order_message_widget"}
        ...
        {/if}
        {if $amazon_pa_enabled and $minicart_total_items gt 0}
