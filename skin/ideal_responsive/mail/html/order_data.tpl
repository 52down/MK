{*
0559ca8bda5978a4247cd80d0c9c0635f06a7290, v13 (xcart_4_7_8), 2017-06-01 10:08:00, order_data.tpl, Ildar
...
<table {if $is_nomail eq 'Y'}cellspacing="1"{else}cellspacing="0" width="100%" border="1"{/if} class="invoice-products" summary="{$lng.lbl_products|escape}">
  ...
  {foreach from=$products item=product}
    ...
    <tr>
      <td class="invoice-price-column">{$product.productcode}{if $active_modules.ShippingEasy ne '' and $order.status eq 'S' and $product.shipped_se eq 'Y'} (<strong style="color: red;">{$lng.lbl_shippingeasy_shipped}<strong>){/if}</td>
