{*
b9cf72503764b09e25f3db9f8c958fb857441c01, v21 (xcart_4_7_7), 2016-12-27 20:27:17, product_details.tpl, aim
  ...
  <div class="product-properties">
    ...
    {if $product.appearance.has_market_price and $product.appearance.market_price_discount gt 0 or $variant_list_price_no_empty}
      <div id="list_price_container">
        ...
        <div class="property-value product-taxed-price">{currency value=$product.list_price tag_id="product_list_price"}</div>
        <div class="separator"></div>
      </div>
    {/if}
    ...
    {if $product.forsale neq "B" or ($product.forsale eq "B" and $smarty.get.pconf ne "" and $active_modules.Product_Configurator)}
      ...
      {if $active_modules.Product_Options ne ""}
        {include file="modules/Product_Options/customer_options.tpl" disable=$lock_options include_table_tag='Y'}
      {/if}
