{*
cbd5b33537a292f5a3d487cfe98638e2e7f94a89, v2 (xcart_4_7_5), 2016-02-08 20:36:40, add_coupon.tpl, aim
  ...
  <div class="add-coupon">
    <form action="cart.php" name="couponform">
      ...
      <div class="data-name">
        ...
        <input type="text" class="text default-value" size="32" name="coupon" id="coupon" placeholder="{$lng.lbl_coupon_code|escape}" />
      </div>
