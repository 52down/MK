...
{else}
  {include file="customer/buttons/button.tpl" button_title="<span class='fa fa-check'></span>`$lng.lbl_add_more`" additional_button_class=$additional_button_class|cat:' add-to-cart-button added-to-cart-button'}
{/if}
