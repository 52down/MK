{*
0a0cbe33e6cd27892b7a2ac44173c2f57a1de4ae, v2 (xcart_4_7_3), 2015-06-15 16:57:41, products_list.tpl, aim
...
//]]>
    ...
    <div{interline name=products foreach_iteration="`$smarty.foreach.products.iteration`" foreach_total="`$smarty.foreach.products.total`" additional_class=item}>
      ...
      {if $active_modules.Socialize
        and (($is_matrix_view and $config.Socialize.soc_plist_matrix eq "Y") or (!$is_matrix_view and $config.Socialize.soc_plist_plain eq "Y"))
      }
