{*
b9cf72503764b09e25f3db9f8c958fb857441c01, v6 (xcart_4_7_7), 2016-12-27 20:27:17, product_details.tpl, aim
  ...
  <tbody>
    ...
    {if $product.appearance.has_market_price and $product.appearance.market_price_discount gt 0 or $variant_list_price_no_empty}
      <tr id="list_price_container">
        ...
        <td class="property-value product-taxed-price" colspan="2">{currency value=$product.list_price tag_id="product_list_price"}
