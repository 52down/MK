{*
41562c5cfeb62cd856c8982b2d194c8a49e4f4c3, v4 (xcart_4_7_7), 2016-12-26 19:10:26, cart.tpl, aim
      ...
      <form action="cart.php" method="post" name="cartform">
        ...
        {foreach from=$products item=product name=products}
          {if $product.hidden eq ""}
            ...
            <table cellspacing="0"{interline name=products foreach_iteration="`$smarty.foreach.products.iteration`" foreach_total="`$smarty.foreach.products.total`" additional_class="width-100 item"} summary="{$product.product|escape}">
        ...
        <div class="buttons">
          ...
          <div class="left-buttons-row buttons-row buttons-auto-separator">
