{*
aff759aa082b708fb9d5791aff835139b48d89cd, v2 (xcart_4_7_5), 2016-01-05 19:33:50, profile_data.tpl, aim
...
<table class="block-grid data-table">
  ...
  {if $address_book_data.B or $address_book_data.S}
    ...
    <tr>
      <td><b>{$lng.lbl_billing_address}</b><br />{include file="customer/main/address_details_html.tpl" address=$address_book_data.B default_fields=$userinfo.default_address_fields additional_fields_type='B'}</td>
      <td><b>{$lng.lbl_shipping_address}</b><br />{include file="customer/main/address_details_html.tpl" address=$address_book_data.S default_fields=$userinfo.default_address_fields additional_fields_type='S'}</td>
    </tr>
  {/if}
