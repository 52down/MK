{*
5ad2383c1775174a30b4d90153991d71abede2d5, v13 (xcart_4_7_7), 2017-01-21 18:02:12, minicart.tpl, aim
...
<div class="minicart-box">
  ...
  <form action="{$xcart_web_dir}/cart.php" method="post" name="minicartform">
   ...
   <ul class="menu">
      ...
      {if $paypal_express_active or $amazon_pa_enabled or $pilibaba_enabled}
