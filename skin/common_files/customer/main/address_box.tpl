{*
602378b421e35a45cfd6a97cf0272533b49094ff, v12 (xcart_4_7_4), 2015-10-19 13:55:56, address_box.tpl, random 
    ...
    <div class="address-main">
      ...
      {else}
        ...
        <div class="buttons-row buttons-auto-separator">
          {if not (($checkout_module eq 'One_Page_Checkout' and $for eq 'cart') or $for eq 'save_card')}
          ...
          {if $address.default_s ne 'Y' and $address.default_b ne 'Y'}
            {include file="customer/buttons/button.tpl" button_title=$lng.lbl_delete href="javascript: if (confirm(txt_are_you_sure)) self.location = 'address_book.php?mode=delete&amp;id=`$address.id`'"}
          {/if}
        </div>
