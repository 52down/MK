{*
41562c5cfeb62cd856c8982b2d194c8a49e4f4c3, v13 (xcart_4_7_7), 2016-12-26 19:10:26, cart_subtotal.tpl, aim

vim: set ts=2 sw=2 sts=2 et:
*}
<div class="right-box cart-border">
...
{foreach key=tax_name item=tax from=$cart.taxes}
    <tr class="total-tax-line">
      ...
      <td>{currency value=$tax.taxcost_without_shipping}</td>
      <td>{alter_currency value=$tax.taxcost_without_shipping}</td>
    </tr>
{/foreach}
...
{if $active_modules.Bongo_International and $cart.bongo_landedCost ne ''}
  {include file="modules/Bongo_International/cart_subtotal.tpl"}
{/if}
