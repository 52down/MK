{*
194626627da00f55901e393daa481ee1a5d33cfb, v8 (xcart_4_7_4), 2015-10-26 13:19:01, order_message.tpl, aim
  ...
  {if $this_is_printable_version eq ""}
    ...
    <div class="buttons-row center">
      <div class="halign-center">
        ...
        {if $active_modules.XAuth and $config.XAuth.xauth_ss_api_version neq '3'}
    ...
    {if $active_modules.XAuth and $config.XAuth.xauth_ss_api_version eq '3'}
      {include file="modules/XAuth/rpx_ss_invoice.tpl"}
    {/if}
