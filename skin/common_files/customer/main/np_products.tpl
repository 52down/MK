{*
052b0e018559744acbd5b8f8fb4e3fa72ab9ed80, v6 (xcart_4_7_4), 2015-10-09 17:51:01, np_products.tpl, aim
...
{if $prev_product}
    ...
    <div class="popup" id="np-popup-prev"><img src="{$ImagesDir}/loading.gif" alt="{$lng.lbl_loading|strip_tags}" /></div>
  </li>
{/if}
...
{if $next_product}
  <li class="last">
    ...
    <div class="popup" id="np-popup-next"><img src="{$ImagesDir}/loading.gif" alt="{$lng.lbl_loading|strip_tags}" /></div>
</li>
{/if}
