{*
0559ca8bda5978a4247cd80d0c9c0635f06a7290, v33 (xcart_4_7_8), 2017-06-01 10:08:00, home.tpl, Ildar
...
{include file="head_admin.tpl" need_quick_search="Y" menu="single"}
<!-- main area -->
...
{elseif $main eq "xpc_admin"}
{include file="modules/XPayments_Connector/xpc_admin.tpl"}
...
{elseif $main eq "banner_system"}
{include file="modules/Banner_System/banner_system_modify.tpl"}

{elseif $main eq "banner_content"}
{include file="modules/Banner_System/banner_content_modify.tpl"}
...
{elseif $main eq "add_realtime_methods"}
{include file="admin/main/add_realtime_methods.tpl"}
...
{include file="modules/Adv_Mailchimp_Subscription/news_common.tpl"}

{elseif $main eq "icontact_news_management"}
{include file="modules/IContact_Subscription/news_common.tpl"}
...
{elseif $main eq "lexity"}
{include file="modules/Lexity/main.tpl"}

{elseif $main eq "xmonitoring"}
{include file="modules/XMonitoring/main.tpl"}

{elseif $main eq "logs"}
{include file="admin/main/logs.tpl"}

{elseif $main eq "multi_currency"}
{include file="modules/XMultiCurrency/admin/currencies.tpl"}

{elseif $main eq "order_statuses"}
{include file="modules/XOrder_Statuses/order_statuses.tpl"}

{elseif $main eq "tickets" and $active_modules.Kayako_Connector ne ""}
{include file="modules/Kayako_Connector/admin/tickets_main.tpl"}

{elseif $main eq "xbackup" and $active_modules.XBackup ne ""}
{include file="modules/XBackup/main.tpl"}

{elseif $main eq "abandoned_carts"}
{include file="modules/Abandoned_Cart_Reminder/abandoned_carts.tpl"}

{elseif $main eq "abandoned_carts_statistic"}
{include file="modules/Abandoned_Cart_Reminder/order_statistic.tpl"}

{elseif $main eq "print_barcodes" and $active_modules.POS_System ne ""}
{include file="modules/POS_System/products_barcodes.tpl"}

{elseif $main eq "edit_testimonial"}
{include file="modules/Testimonials/admin_edit_testimonial.tpl"}

{elseif $main eq "testimonials"}
{include file="modules/Testimonials/admin_testimonials_list.tpl"}

{elseif $main eq "shippingeasy_statuses"}
{include file="modules/ShippingEasy/shippingeasy_statuses.tpl"}

{elseif $main eq "alibaba_wholesale_catalog" and $active_modules.Alibaba_Wholesale ne ""}
{include file="modules/Alibaba_Wholesale/aw_catalog.tpl"}

{elseif $main eq "parcels" and $active_modules.Pitney_Bowes ne ""}
{include file="modules/Pitney_Bowes/parcels.tpl"}

{elseif $main eq "parcel_items" and $active_modules.Pitney_Bowes ne ""}
{include file="modules/Pitney_Bowes/parcel_items.tpl"}
