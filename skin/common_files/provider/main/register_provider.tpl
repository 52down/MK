{*
aba9bb66ca0b7941017e06ce77105af80df2c3c0, v7 (xcart_4_7_4), 2015-07-16 11:15:27, register_provider.tpl, mixon
...
{if $userinfo.need_dhl_info eq "Y"}

<tr>
<td colspan="2" align="center">{include file="main/subheader.tpl" title=$lng.lbl_dhl_provider_section}</td>
</tr>

<tr>
<td align="right">{$lng.opt_DHL_id}:</td>
<td nowrap="nowrap">
{$userinfo.seller_dhl_id|escape}
</td>
</tr>

<tr>
<td align="right">{$lng.opt_DHL_password}:</td>
<td nowrap="nowrap">
{$userinfo.seller_dhl_password|escape}
</td>
</tr>

<tr>
<td align="right">{$lng.opt_DHL_account}:</td>
<td nowrap="nowrap">
{$userinfo.seller_dhl_account|escape}
</td>
</tr>
...
<tr>
<td colspan="3" align="center">{include file="main/subheader.tpl" title=$lng.lbl_dhl_provider_section}</td>
</tr>

<tr>
<td class="data-name">{$lng.opt_DHL_id}:</td>
<td>&nbsp;</td>
<td nowrap="nowrap">
<input type="text" name="dhl_id" value="{$userinfo.seller_dhl_id|escape}" />
</td>
</tr>

<tr>
<td class="data-name">{$lng.opt_DHL_password}:</td>
<td>&nbsp;</td>
<td nowrap="nowrap">
<input type="text" name="dhl_password" value="{$userinfo.seller_dhl_password|escape}" />
</td>
</tr>

<tr>
<td class="data-name">{$lng.opt_DHL_account}:</td>
<td>&nbsp;</td>
<td nowrap="nowrap">
<input type="text" name="dhl_account" value="{$userinfo.seller_dhl_account|escape}" />
</td>
</tr>

<tr>
<td colspan="3" align="left"><b>{$lng.lbl_note}:</b> {$lng.lbl_dhl_provider_note}</td>
</tr>
