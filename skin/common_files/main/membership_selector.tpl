{*
1156aca060fdf0df8a68183c9201b2bf5fd57768, v3 (xcart_4_7_7), 2016-12-01 10:40:01, membership_selector.tpl, aim
...
<select name="{$field}" multiple="multiple" size="{$size}">
  <option value="-1"{if $data.membershipids|default:'' eq "" or ($data.membershipids[0] ne '')} selected="selected"{/if}>{$lng.lbl_all}</option>
  {if $memberships}
