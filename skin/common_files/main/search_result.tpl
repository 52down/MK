{*
039f19367a96265362bfed075aa4e6a50af287c8, v12 (xcart_4_7_5), 2016-01-30 17:39:30, search_result.tpl, mixon
...
{if $active_modules.POS_System}
<tr>
  <td height="10" width="20%" class="FormButton" nowrap="nowrap">{$lng.lbl_pos_upc}:</td>
  <td height="10" width="80%"><input type="text" maxlength="64" name="posted_data[upc]" value="{$search_prefilled.upc|escape}" style="width:70%" /></td>
</tr>
{/if}
...
<tr>
  ...
  {if $active_modules.New_Arrivals}
    {include file="modules/New_Arrivals/new_arrivals_search_by_date.tpl"}
  {/if}

  {if $active_modules.Alibaba_Wholesale}
    {include file="modules/Alibaba_Wholesale/aw_products_search.tpl"}
  {/if}

  {if $active_modules.Amazon_Feeds}
    {include file="modules/Amazon_Feeds/products_search.tpl"}
  {/if}
...
{if $active_modules.POS_System}
  {include file="modules/POS_System/search_result_print_barcodes_button.tpl"}
{/if}
