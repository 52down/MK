{*
2c150253acd7fb2a890c5731390ee95bc170d71f, v5 (xcart_4_7_6), 2016-06-09 11:04:33, products_lng.tpl, aim
...
{include file="main/textarea.tpl" name="product_lng[descr]" cols=45 rows=8 class="InputWidth" data=$product_languages.descr width="80%" btn_rows=4 entity_id=$product.productid entity_type='product_descr'}
...
<tr>
  ...
  <td>&nbsp;</td>
  <td class="ProductDetails">
{include file="main/textarea.tpl" name="product_lng[fulldescr]" cols=45 rows=12 class="InputWidth" data=$product_languages.fulldescr width="80%" btn_rows=4 entity_id=$product.productid entity_type='product_fulldescr'}
  </td>
</tr>
</table>
