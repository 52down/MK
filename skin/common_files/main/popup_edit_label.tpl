{*
2c150253acd7fb2a890c5731390ee95bc170d71f, v8 (xcart_4_7_6), 2016-06-09 11:04:33, popup_edit_label.tpl, aim
...
{include file="main/textarea.tpl" cols=100 rows=10 data=$labelText name="val" width="640px" style="width: 640px;" on_js_editor_ready=resizeWnd entity_type='label'}
{else}
{include file="main/textarea.tpl" cols=100 rows=5 data=$labelText name="val" width="640px" style="width: 640px;" btn_rows=4 on_js_editor_ready=resizeWnd entity_type='label'}
{/if}
{else}
