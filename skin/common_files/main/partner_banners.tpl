{*
978f1c535739a5a65118fa076e5b684c3874557c, v9 (xcart_4_7_5), 2016-01-11 13:31:52, partner_banners.tpl, aim
...
{elseif $banner_type ne ''}
  ...
  <form action="{$current_location}/banner.php?type=preview&amp;test={$smarty.now}&amp;preview_get_key={$preview_get_key}" method="post" name="previewform" target="previewwin">
