{*
18d78d9894a6cbd1dd5972d0abfa848765f4afc4, v11 (xcart_4_7_5), 2015-11-19 12:10:51, tooltip_js.tpl, aim
...
{elseif $type eq 'img'}
  ...
  <a href="javascript:void(0);" class="" id="{$id|default:"tooltip_link"}"{if $show_title} title="{$title|escape}"{/if} {if $ajax_source}rel="{$ajax_source}"{else}rel="#{$id|default:"tooltip_link"}_tooltip"{/if} tabindex="-1" >
