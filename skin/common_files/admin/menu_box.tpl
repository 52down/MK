{*
0559ca8bda5978a4247cd80d0c9c0635f06a7290, v34 (xcart_4_7_8), 2017-06-01 10:08:00, menu_box.tpl, Ildar
...
{/if}
<a href="{$catalogs.admin}/accounting_adv.php">{$lng.lbl_accounting}</a>
</div>
</li>
...
<a href="{$catalogs.admin}/alibaba_wholesale_catalog.php">{$lng.lbl_aw_add_product}</a>
{/if}
...
<a href="{$catalogs.admin}/xorder_statuses.php">{$lng.lbl_xostat_order_statuses}</a>
{/if}
...
{/if}
{* -- XMULTICURRENCY -- *}
{if $active_modules.ShippingEasy}
<a href="{$catalogs.admin}/shippingeasy_statuses.php">{$lng.lbl_shippingeasy_statuses}</a>
{/if}
</div>
</li>
...
<a href="{$catalogs.admin}/icontact_news.php">{$lng.lbl_icontact_news_management}</a>
{/if}
