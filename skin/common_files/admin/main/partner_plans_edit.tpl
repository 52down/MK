{*
f796cd4ac105eb160691c59c49e70773bd16b2d8, v6 (xcart_4_7_7), 2016-09-01 16:39:33, partner_plans_edit.tpl, mixon

vim: set ts=2 sw=2 sts=2 et:
*}
{capture name=js_ajax_search_by_sku_fields_partners}
  var autocomplete_field_selector = "#product_ids";
  var js_ajax_session_quick_key = "{get_ajax_session_quick_key|escape:javascript}";
{/capture}
{load_defer file="js_ajax_search_by_sku_fields_partners" direct_info=$smarty.capture.js_ajax_search_by_sku_fields_partners type="js"}
    ...
    <table cellpadding="2" cellspacing="2" width="100%">
      ...
      <tr>
        <td colspan="3">
          ...
          {$lng.lbl_product} #:
          <input name="product_ids" id="product_ids" size="64" autofocus="autofocus" placeholder="{$lng.lbl_enter_skus|strip_tags:false|escape}" />
          <input type="button" value="{$lng.lbl_find_products_|strip_tags:false|escape}"  onclick="javascript: popup_product('commissionsform.newproduct', 'commissionsform.product_ids');" tabindex="-1" />
        </td>
