{*
2c150253acd7fb2a890c5731390ee95bc170d71f, v2 (xcart_4_7_6), 2016-06-09 11:04:33, category_lng.tpl, aim
...
<tr>
  ...
  <td>{include file="main/textarea.tpl" name="category_lng[description]" cols=45 rows=6 data=$category_lng.description width="100%" style="width: 100%;" entity_id=$cat entity_type='category_lng_description'}</td>
</tr>
