{*
87417a2ea022a27a2af2a0bb910bf1ec767fec41, v6 (xcart_4_7_3), 2015-06-19 13:47:03, partner_adv_campaigns.tpl, aim
...
<tr>
  ...
  <td>
    {include file="main/datepicker.tpl" name="start_date" date=$campaign.start_period|default:$month_begin start_year="c-2" end_year="+5"}
  </td>
</tr>
<tr>
  <td nowrap="nowrap">{$lng.lbl_period_to}:</td>
  <td>
    {include file="main/datepicker.tpl" name="end_date" date=$campaign.end_period|default:$month_begin start_year="c-2" end_year="+5"}
  </td>
</tr>
<tr> 
