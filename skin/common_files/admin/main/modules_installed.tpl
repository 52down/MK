{*
313c02bda87b5fcd8b8e8205beea1adf393448f2, v11 (xcart_4_7_3), 2015-06-29 11:56:29, modules_installed.tpl, aim
...
<div class="module-settings">
  ...
  {assign var="module_requirements" value="module_requirements_`$m.module_name`"}
  <input type="checkbox" id="{$m.module_name}" name="{$m.module_name}"{if $m.active eq "Y"} checked="checked"{/if}{if (not $m.requirements_passed and $m.active eq "N") or $admin_safe_mode} disabled="disabled"{/if}{if !$admin_safe_mode} onclick="javascript: toggleModule('{$m.module_name}');"{/if} />
