{*
9344c06d575522edb3521b831beab663ca4fad11, v9 (xcart_4_7_6), 2016-06-09 15:19:06, languages.tpl, aim
...
<tr>
  <td colspan="2">
{include file="main/textarea.tpl" name="new_var_value" cols=70 rows=8 data="" width="100%" style="width: 100%;" entity_type='label'}
  </td>
</tr>
...
<tr>
  ...
  <br /><font class="Star">{$lng.lbl_warning}!</font> {$lng.txt_max_file_size_charset_warning|substitute:"upload_max_filesize":$upload_max_filesize:"default_charset":$default_charset}
  {/if}
  </div>
