{*
21c655c239f3b464cd022dcdca5ef27220885438, v9 (xcart_4_7_6), 2016-06-10 18:26:17, test_shippings.tpl, aim
...
<tr valign="middle">
  <td align="right" nowrap="nowrap">{$lng.lbl_productid}:</td>
  <td>&nbsp;</td>
  <td nowrap="nowrap" width="75%"><input type="text" name="productid" value="{$productid}" /></td>
</tr>
...
<tr valign="middle">
  <td align="right" nowrap="nowrap">{$lng.lbl_length} {if $config.General.dimensions_symbol}({$config.General.dimensions_symbol}){/if}:</td>
  <td>&nbsp;</td>
  <td nowrap="nowrap" width="75%"><input type="text" name="length" value="{$length}" /></td>
</tr>

<tr valign="middle">
  <td align="right" nowrap="nowrap">{$lng.lbl_width} {if $config.General.dimensions_symbol}({$config.General.dimensions_symbol}){/if}:</td>
  <td>&nbsp;</td>
  <td nowrap="nowrap" width="75%"><input type="text" name="width" value="{$width}" /></td>
</tr>

<tr valign="middle">
  <td align="right" nowrap="nowrap">{$lng.lbl_height} {if $config.General.dimensions_symbol}({$config.General.dimensions_symbol}){/if}:</td>
  <td>&nbsp;</td>
  <td nowrap="nowrap" width="75%"><input type="text" name="height" value="{$height}" /></td>
</tr>

<tr valign="middle">
  <td align="right" nowrap="nowrap">{$lng.lbl_quantity}:</td>
  <td>&nbsp;</td>
  <td nowrap="nowrap" width="75%"><input type="text" name="amount" value="{$amount}" /></td>
</tr>

<tr valign="middle">
  <td align="right" nowrap="nowrap">{$lng.lbl_price}:</td>
  <td>&nbsp;</td>
  <td nowrap="nowrap" width="75%"><input type="text" name="price" value="{$price}" /></td>
</tr>

{if $active_modules.UPS_OnLine_Tools and $config.Shipping.realtime_shipping eq "Y" and $config.Shipping.use_intershipper ne "Y" and !$smarty.const.ALL_CARRIERS}
<tr>
