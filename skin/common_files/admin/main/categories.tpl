{*
b9a914d1b0f80d501443a116da345c051b49b12a, v4 (xcart_4_7_6), 2016-03-17 18:51:54, categories.tpl, aim
...
<tr class="TableHead">
  ...
  {if $active_modules.New_Arrivals}
    {include file="modules/New_Arrivals/new_arrivals_categories_selector.tpl" is_header="Y" is_list="Y"}
  {/if}
...
{/if}
  ...
  {if $active_modules.New_Arrivals}
    {include file="modules/New_Arrivals/new_arrivals_categories_selector.tpl" category=$c categoryid=$catid is_list="Y"}
  {/if}
  <td align="center">
