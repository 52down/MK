{*
be9581a5c8bee4302a16debb9e0897116cdf6192, v22 (xcart_4_7_8), 2017-04-03 20:33:15, tools.tpl, aim
...
var txt_check_tpl_syntax_warning = "{$lng.txt_check_tpl_syntax_warning|wm_remove|escape:javascript}";
var txt_increase_orderid_confirm = "{$lng.txt_increase_orderid_confirm|wm_remove|escape:javascript}";
...
{*** Check all tpl syntax  {{{***}
<a name="check_tpl_syntax"></a>

{include file="main/subheader.tpl" title=$lng.lbl_check_tpl_syntax}

<form action="tools.php?start_tpl_syntax_checking=Y" method="post" onsubmit="javascript: return confirm(txt_check_tpl_syntax_warning);">
<table cellpadding="2" cellspacing="0" width="100%">

<tr id="check_tpl_syntax_small">
  <td colspan="2">{$lng.txt_check_tpl_syntax_small_note}&nbsp;<a href="javascript:void(0);" onclick="javascript: clickMore('check_tpl_syntax_small');">{$lng.lbl_more}</a></td>
</tr>
<tr id="check_tpl_syntax_small_note" style="display: none;">
  <td colspan="2">{$lng.txt_check_tpl_syntax_note}</td>
</tr>
<tr>
  <td colspan="2" class="SubmitBox"><input type="submit" value="{$lng.lbl_check|strip_tags:false|escape}" />
  </td>
</tr>
...
<tr>
  ...
  <tr id="tr_select_date" style="display: none;">
    <td>&nbsp;</td>
    <td>{html_select_date prefix="RSD_" start_year=$rsd_start_year month_names=$_month_names}</td>
  </tr>
  </table>
  </td>
</tr>
...
{if $count_orders2generate_anonymous_customers}

<a name="generate_anonymous_customers"></a>

{include file="main/subheader.tpl" title=$lng.lbl_generate_anonymous_customers}

<form action="tools.php?start_generate_anonymous=Y" method="post">
  <input type="submit" value="{$lng.lbl_generate_anonymous_customers|strip_tags:false|escape}" />
</form>
...
{*** Extract applied offers from orders {{{***}
{if $config.applied_offers_need2be_converted}

<a name="repack_order_applied_offers"></a>

{include file="main/subheader.tpl" title=$lng.lbl_optimize_orders_structure}

<form action="tools.php?start_repack_order_applied_offers=Y" method="post" onsubmit="javascript: return confirm(txt_check_tpl_syntax_warning);">
  <input type="submit" value="{$lng.lbl_optimize_orders_structure|strip_tags:false|escape}" />
</form>
...
<form action="tools.php" method="post" name="formmode_clear_db" onsubmit="javascript: return check_cc_assurance();" id="formmode_clear_db">
<table cellpadding="2" cellspacing="0" width="100%">
...
<a name="increase_init_orderid"></a>

{include file="main/subheader.tpl" title=$lng.lbl_increase_init_orderid}

<form action="tools.php" method="post" name="formmode_increase_init_orderid" onsubmit="javascript: return confirm(txt_increase_orderid_confirm);">
<table cellpadding="2" cellspacing="0" width="100%">

<tr id="increase_init_orderid_small">
  <td colspan="2">{$lng.txt_increase_init_orderid_small_note}&nbsp;<a href="javascript:void(0);" onclick="javascript: clickMore('increase_init_orderid_small');">{$lng.lbl_more}</a></td>
</tr>
<tr id="increase_init_orderid_small_note" style="display: none;">
  <td colspan="2">{$lng.txt_increase_init_orderid_note}</td>
</tr>
<tr>
  <td><input type="text" name="new_init_orderid" size="10" value="{$possible_new_init_orderid}" /></td>
</tr>
<tr>
  <td colspan="2" class="SubmitBox"><input type="submit" name="increase_init_orderid" value="{$lng.lbl_update|strip_tags:false|escape}" />
  </td>
</tr>
