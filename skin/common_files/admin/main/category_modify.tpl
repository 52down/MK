{*
2c150253acd7fb2a890c5731390ee95bc170d71f, v11 (xcart_4_7_6), 2016-06-09 11:04:33, category_modify.tpl, aim
...
<tr>
  ...
  <td width="10" height="10"><font class="Star"></font></td>
  <td height="10">
    {include file="main/textarea.tpl" name="description" cols=65 rows=15 data=$current_category.description entity_id=$current_category.categoryid entity_type='category_description'}
  </td>
</tr>
...
{if $active_modules.New_Arrivals}
  {include file="modules/New_Arrivals/new_arrivals_categories_selector.tpl" category=$current_category is_details="Y"}
{/if}
...
<tr>
  ...
  <td width="10" height="10"><font class="FormButtonOrange"></font></td>
  <td height="10">
    <textarea cols="65" rows="4" name="title_tag" maxlength="255">{$current_category.title_tag|escape:"html"}</textarea>
  </td>
</tr>
...
<tr>
  ...
  <td width="10" height="10"><font class="FormButtonOrange"></font></td>
  <td height="10">
    <textarea cols="65" rows="4" name="meta_keywords" maxlength="255">{$current_category.meta_keywords|escape:"html"}</textarea>
  </td>
</tr>
...
<tr>
  ...
  <td width="10" height="10"><font class="FormButtonOrange"></font></td>
  <td height="10">
    <textarea cols="65" rows="4" name="meta_description" maxlength="255">{$current_category.meta_description|escape:"html"}</textarea>
  </td>
</tr>
...
<tr>
  ...
  <td class="SubmitBox"><input type="button" value="{$lng.lbl_move|strip_tags:false|escape}" onclick="javascript: submitForm(this, 'move');" /></td>
</tr>
