{*
194626627da00f55901e393daa481ee1a5d33cfb, v20 (xcart_4_7_4), 2015-10-26 13:19:01, cc_processing.tpl, aim
  ...
  <form action="cc_processing.php" method="get" name="myform">
    ...
    <table cellpadding="2" cellspacing="1" width="100%">
      ...
      <tr>
        ...
        <td nowrap="nowrap">
          {include file="buttons/button.tpl" button_title=$lng.lbl_add href="javascript: if (document.myform.processor.value.match(/^XPay_Module.*$/)) popupOpen('popup_info.php?action=usexp','XPC_METHODS_HELP',`$smarty.ldelim`width:550,height:500`$smarty.rdelim`); else if (document.myform.processor.selectedIndex > 0) document.myform.submit();"}
        </td>
      </tr>
