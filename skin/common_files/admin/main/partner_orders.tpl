{*
ac8c94920113307390c6b99bee08baf69d0fbf39, v7 (xcart_4_7_5), 2016-02-18 10:02:02, partner_orders.tpl, aim
...
{capture name=dialog}
  ...
  <form method="post" action="partner_orders.php" name="searchform">
    ...
    <table>
      <tr>
        <td height="10" class="FormButton" nowrap="nowrap">{$lng.lbl_date_period}:</td>
        <td height="10" width="10">&nbsp;</td>
        <td nowrap="nowrap">
          {include file="widgets/daterangepicker/daterangepicker.tpl" name="date_range" startDate=$search.start_date endDate=$search.end_date}
        </td>
      </tr>
      <tr>
