{*
540830e1020194a4c9dd88e4edf9102270e1c702, v7 (xcart_4_7_7), 2016-08-09 18:00:14, page_edit.tpl, aim
...
{if $level eq "E"}
{include file="main/textarea.tpl" name="pagecontent" cols=50 rows=30 data=$page_content btn_rows=4 entity_id=$pageid entity_type='pagecontent_E' skip_escape=false}
{else}
{include file="main/textarea.tpl" name="pagecontent" cols=50 rows=30 data=$page_content btn_rows=4 html_editor_mode="XHTML" entity_id=$pageid entity_type='pagecontent_R'}
{/if}
  </td>
</tr>
...
<tr>
  ...
  <td>&nbsp;</td>
  <td><textarea name="title_tag" maxlength="255" rows="6" cols="85">{$page_data.title_tag|default:"$default_title_tag"}</textarea></td>
</tr>

<tr>
  <td height="10" class="FormButton" nowrap="nowrap" valign="top">{$lng.lbl_meta_keywords}:</td>
  <td>&nbsp;</td>
  <td><textarea name="meta_keywords" maxlength="255" rows="6" cols="85">{$page_data.meta_keywords|default:"$default_meta_keywords"}</textarea></td>
</tr>

<tr>
  <td height="10" class="FormButton" nowrap="nowrap" valign="top">{$lng.lbl_meta_description}:</td>
  <td>&nbsp;</td>
  <td><textarea name="meta_description" maxlength="255" rows="6" cols="85">{$page_data.meta_description|default:"$default_meta_description"}</textarea></td>
</tr>
{/if}
