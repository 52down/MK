{*
194626627da00f55901e393daa481ee1a5d33cfb, v5 (xcart_4_7_4), 2015-10-26 13:19:01, tax_edit.tpl, aim
...
<table cellpadding="1" cellspacing="1">
<tr>
  <td><input type="checkbox" id="hide_zero_value_tax" name="hide_zero_value_tax" value="Y"{if $tax_details.hide_zero_value_tax eq "Y"} checked="checked"{/if} /></td>
  <td class="FormButton"><label for="hide_zero_value_tax">{$lng.lbl_hide_zero_value_tax}</label></td>
</tr>
</table>
