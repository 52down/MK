{*
aba9bb66ca0b7941017e06ce77105af80df2c3c0, v7 (xcart_4_7_4), 2015-07-16 11:15:27, general.tpl, mixon
...
<td nowrap="nowrap">
{if $key eq "F" or $key eq "D"}{include file="main/order_status.tpl" status="F" mode="static"}/{include file="main/order_status.tpl" status="D" mode="static"}{else}{include file="main/order_status.tpl" status=$key mode="static"}{/if}:
</td>
...
{$environment_info[idx].data}{if $environment_info[idx].txt_tooltip ne ""}{include file="main/tooltip_js.tpl" text=$environment_info[idx].txt_tooltip id="environment_help_`$smarty.section.idx.index`" type='img' sticky=true}{/if}
{else}
