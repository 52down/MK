{*
2c150253acd7fb2a890c5731390ee95bc170d71f, v2 (xcart_4_7_6), 2016-06-09 11:04:33, news_messages_modify.tpl, aim
...
<tr>
  ...
  <td>
{include file="main/textarea.tpl" name="message[body]" cols=50 rows=10 style="width: 90%;" data=$message.body width="90%" btn_rows=3 entity_id=$message.newsid entity_type='news_message_body'}
  </td>
