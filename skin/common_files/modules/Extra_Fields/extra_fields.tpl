{*
194626627da00f55901e393daa481ee1a5d33cfb, v6 (xcart_4_7_4), 2015-10-26 13:19:01, extra_fields.tpl, aim
...
<tr{cycle values=", class='TableSubHead'"}>
  ...
  <td><input type="text" name="posted_data[{$id}][service_name]" maxlength="128" size="25" value="{$field.service_name|escape}" /></td>
