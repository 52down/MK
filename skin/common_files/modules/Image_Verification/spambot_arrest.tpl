{*
834ead82b3afb3f56e1e9fb461c0a33e1af88c4c, v9 (xcart_4_7_6), 2016-06-14 12:34:40, spambot_arrest.tpl, aim
      ...
      <div class="iv-input valign-middle-adv-lvl1">
        <div class="valign-middle-adv-lvl2">
          <div class="valign-middle-adv-lvl3">
            ...
            <input type="text" id="{$antibot_input_str_name}" name="{$antibot_input_str_name}"{if $antibot_err} class="err"{/if} autocomplete="off" />
            {if $button_code}
              <div>
                {$button_code}
              </div>
