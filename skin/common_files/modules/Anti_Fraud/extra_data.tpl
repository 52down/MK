{*
442247067db63ddbfaaef7de30c2fd9530d4b850, v5 (xcart_4_7_8), 2017-06-06 16:31:36, extra_data.tpl, aim

vim: set ts=2 sw=2 sts=2 et:
*}
{if $active_modules.Anti_Fraud or not $active_modules.XPayments_Connector or not $order.extra.xpc_fraud_check_data}
  {if $is_invoice_page}
...
{if $active_modules.Anti_Fraud}
  ...
  {/if}
{else}
  {if not $active_modules.XPayments_Connector or not $order.extra.xpc_fraud_check_data}
