{*
fe8b1e17cef11d5c42987358726a6e273f3aa44e, v2 (xcart_4_7_7), 2016-08-30 13:02:49, payment_klarna.tpl, aim
  ...
  <li class="single-field">
    {capture name=regfield}
      ...
      {if $config.Klarna_Payments.user_country eq 'de' or $config.Klarna_Payments.user_country eq 'nl'}
        {include file="main/datepicker.tpl" name="user_ssn" id="user_ssn_`$payment.paymentid`" start_year="1930" dp_onchange="changeSSN(document.getElementById('user_ssn_`$payment.paymentid`').value);" date=$smarty.now-630720000}{* 86400*365*20 *}
      {else}
