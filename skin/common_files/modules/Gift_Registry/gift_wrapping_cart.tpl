{*
194626627da00f55901e393daa481ee1a5d33cfb, v12 (xcart_4_7_4), 2015-10-26 13:19:01, gift_wrapping_cart.tpl, aim
...
<div class="giftwrapping-cart cart-border">
  <div class="giftwrap-option">
    <label for="need_giftwrap">
      ...
      {$lng.lbl_giftreg_use_wrapping}{if $cart.giftwrap_cost gt 0} ({currency value=$cart.giftwrap_cost display_sign=1}){/if}
    </label>
  </div>
  {if $cart.giftwrap_cost gt 0 and not $single_mode and $config.General.sum_up_wrapping_cost eq "Y" and $cart.is_multiorder eq "Y"}
