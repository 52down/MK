{*
87417a2ea022a27a2af2a0bb910bf1ec767fec41, v5 (xcart_4_7_3), 2015-06-19 13:47:03, event_modify.tpl, aim
...
<form action="giftreg_manage.php" method="post" name="eventdetails_form">
  ...
  <table cellpadding="0" class="data-table width-100" summary="{$lng.lbl_event_info|escape}">
    ...
    <tr>
      ...
      <td class="data-required">*</td>
      <td>
        {include file="main/datepicker.tpl" name="event_date" date=$event_data.event_date end_year="+5"}
      </td>
    </tr>
