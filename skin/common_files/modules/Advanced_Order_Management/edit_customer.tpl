{*
7e396bda7a213f4ae800e7edef50cb7a5d5381d8, v16 (xcart_4_7_8), 2017-04-19 10:42:34, edit_customer.tpl, aim
...
<tr{cycle name=c2 values=', class="TableSubHead"'}{if $address_fields.title.avail ne 'Y'} data-aom-field-not-avail{/if}>
  <td>{$lng.lbl_title}</td>
  <td>
    {include file="main/title_selector.tpl" name="address_book[B][title]" id="b_title" val=$cart_customer.address.B.title compare_title_text="Y" data_orig_value=$customer.b_title data_orig_keep_empty='Y'}
  </td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}{if $address_fields.title.avail ne 'Y'} data-aom-field-not-avail{/if}>
  <td>{$lng.lbl_title}</td>
  <td>
    {include file="main/title_selector.tpl" name="address_book[S][title]" id="s_title" val=$cart_customer.address.S.title compare_title_text="Y" data_orig_value=$customer.s_title data_orig_keep_empty='Y'}
  </td>
