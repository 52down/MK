{*
87417a2ea022a27a2af2a0bb910bf1ec767fec41, v5 (xcart_4_7_3), 2015-06-19 13:47:03, new_arrivals_product_modify_fields.tpl, aim
  ...
  <td class="ProductDetails">
    ...
    <table cellspacing="0" cellpadding="0" class="date-period-specific"{if $product.mark_as_new ne "S"} style="display: none"{/if}>
      <tr>
        ...
        <td>{include file="main/datepicker.tpl" name="show_as_new_from" date=$product.show_as_new_from start_year="c-2" end_year="+5"}</td>
      </tr>
      <tr>
        <td align="right">{$lng.lbl_to}:&nbsp;</td>
        <td>{include file="main/datepicker.tpl" name="show_as_new_to" date=$product.show_as_new_to start_year="c-2" end_year="+5"}</td>
      </tr>
    </table>
  </td>
</tr>
