{*
2c150253acd7fb2a890c5731390ee95bc170d71f, v8 (xcart_4_7_6), 2016-06-09 11:04:33, modify_survey.tpl, aim
...
<tr>
  ...
  <td>{include file="main/datepicker.tpl" name="data[valid_from_date]" id="valid_from_date" date=$survey.valid_from_date start_year="c-2" end_year="+5"}</td>
  <td style="padding-left: 10px; padding-right: 10px;"><b>{$lng.lbl_survey_to}</b></td>
  <td>{include file="main/datepicker.tpl" name="data[expires_data]" id="expires_data" date=$survey.expires_data start_year="c-2" end_year="+5"}</td>
</tr>
</table>
  </td>
</tr>
...
<div id="boxheader">
{include file="main/textarea.tpl" name="add_data[header]" cols=55 rows=10 class="InputWidth" data=$survey.header width="80%" btn_rows=3 entity_id=$surveyid entity_type='survey_header'}
</div>
  </td>
</tr>
...
<div id="boxfooter">
{include file="main/textarea.tpl" name="add_data[footer]" cols=55 rows=10 class="InputWidth" data=$survey.footer width="80%" btn_rows=3 entity_id=$surveyid entity_type='survey_footer'}
</div>
    </td>
</tr>
...
<div id="boxcomplete">
{include file="main/textarea.tpl" name="add_data[complete]" cols=55 rows=10 class="InputWidth" data=$survey.complete width="80%" btn_rows=3 entity_id=$surveyid entity_type='survey_complete'}
</div>
    </td>
</tr>
