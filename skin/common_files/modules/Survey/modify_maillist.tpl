{*
f796cd4ac105eb160691c59c49e70773bd16b2d8, v7 (xcart_4_7_7), 2016-09-01 16:39:33, modify_maillist.tpl, mixon

vim: set ts=2 sw=2 sts=2 et:
*}
{include file="main/multirow.tpl"}
{capture name=js_modify_maillist_direct}
  var autocomplete_field_selector = "input[name='newproduct[0]']";
...
{/capture}
{load_defer file="js_modify_maillist_direct" direct_info=$smarty.capture.js_modify_maillist_direct type="js"}
