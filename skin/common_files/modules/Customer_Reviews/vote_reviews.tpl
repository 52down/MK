{*
89ef7e151189c984159167d93d53ce27d99e1e15, v12 (xcart_4_7_3), 2015-06-16 13:08:37, vote_reviews.tpl, aim
...
{if $printable ne 'Y' or $reviews}
  ...
  {capture name=dialog}
    ...
    {if $active_modules.Socialize && $config.Socialize.soc_fb_comments_enabled eq "Y"}
      ...
      <div class="fb-like" data-href="{$current_location}/{$canonical_url}" data-share="false" data-layout="standard" data-show-faces="true"></div>
