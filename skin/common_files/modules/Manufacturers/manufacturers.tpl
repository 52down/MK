{*
2c150253acd7fb2a890c5731390ee95bc170d71f, v8 (xcart_4_7_6), 2016-06-09 11:04:33, manufacturers.tpl, aim
...
<tr>
  ...
  <td>&nbsp;</td>
  <td>
{include file="main/textarea.tpl" name="descr" cols=55 rows=10 class="InputWidth" data=$manufacturer.descr width="80%" btn_rows=3 entity_id=$manufacturer.manufacturerid entity_type='manufacturer_descr'}
  </td>
</tr>
...
<tr>
    ...
    <td>&nbsp;</td>
    <td><textarea name="title_tag" maxlength="255" rows="6" cols="85"{$disabled}>{$manufacturer.title_tag}</textarea></td>
</tr>

<tr>
    <td class="FormButton">{$lng.lbl_meta_keywords}:</td>
    <td>&nbsp;</td>
    <td><textarea name="meta_keywords" maxlength="255" rows="6" cols="85"{$disabled}>{$manufacturer.meta_keywords}</textarea></td>
</tr>

<tr>
    <td class="FormButton">{$lng.lbl_meta_description}:</td>
    <td>&nbsp;</td>
    <td><textarea name="meta_description" maxlength="255" rows="6" cols="85"{$disabled}>{$manufacturer.meta_description}</textarea></td>
</tr>
