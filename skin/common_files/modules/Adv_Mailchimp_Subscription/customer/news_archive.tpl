{*
16fd72c950254a8d4861815dac0d6147af93e43f, v2 (xcart_4_7_0), 2014-12-23 10:13:26, news_archive.tpl, aim
...
{else}
  ...
  <div class="news-list">
    ...
    {foreach from=$news_messages item=m name=news}
      ...
      <div{interline name=news foreach_iteration="`$smarty.foreach.news.iteration`" foreach_total="`$smarty.foreach.news.total`" additional_class="news-item"}>
