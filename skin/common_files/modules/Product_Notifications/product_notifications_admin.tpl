{*
16fd72c950254a8d4861815dac0d6147af93e43f, v2 (xcart_4_7_0), 2014-12-23 10:13:26, product_notifications_admin.tpl, aim
...
<form action="product_notifications.php" method="post" name="processnotificationsform">
  ...
  <table cellpadding="2" cellspacing="1" width="100%">
    ...
    {foreach from=$notifications item=notification name=notifications}
      <tr{interline name=notifications foreach_iteration="`$smarty.foreach.notifications.iteration`" foreach_total="`$smarty.foreach.notifications.total`" class=TableSubHead}>
        <td width="5">
