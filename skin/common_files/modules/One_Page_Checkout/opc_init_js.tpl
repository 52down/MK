{*
26d381a2e1b8314654dc01e60646e30236d1167f, v24 (xcart_4_7_7), 2016-09-09 09:17:50, opc_init_js.tpl, aim
...
function checkCheckoutForm() {
  ...
  {/literal}
    {if $active_modules.Klarna_Payments}
      ...
      if (de_termsObj && de_termsObj.length > 0 && $(de_termsObj).attr('checked') != 'checked') {ldelim}
