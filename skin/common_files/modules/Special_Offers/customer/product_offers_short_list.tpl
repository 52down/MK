{*
194626627da00f55901e393daa481ee1a5d33cfb, v10 (xcart_4_7_4), 2015-10-26 13:19:01, product_offers_short_list.tpl, aim
...
{if $product_offers}
  ...
  <tr>
    ...
    <tr>
      <td><b>{$lng.lbl_sp_this_item}: </b>{$product.producttitle|amp} <span class="small-note">[{$prod_set.curr_item_amount} {$lng.lbl_sp_items}]</span></td>
    </tr>
    {foreach name=prod_items from=$prod_set.products item=prod_item}
    {if $prod_item.productid ne $product.productid}
    <tr>
      <td><a href="product.php?productid={$prod_item.productid}">{$prod_item.producttitle|amp}</a> <span class="small-note">[{$prod_item.amount} {$lng.lbl_sp_items}]</span></td>
    </tr>
    {/if}
    {/foreach}
    </table>
