{*
d6b54bc9043f25a0142c887e0639e4d60248808f, v4 (xcart_4_7_6), 2016-06-13 12:22:08, ups_regform.tpl, aim
...
<tr>
  <td class="Star">*<input type="radio" id="software_installer_yes" name="posted_data[software_installer]" value="yes"{if $userinfo.software_installer eq "yes"} checked="checked"{/if} /></td>
  <td><label for="software_installer_yes">{$lng.lbl_yes}</label></td>
  <td>&nbsp;&nbsp;</td>
  <td class="Star">*<input type="radio" id="software_installer_no" name="posted_data[software_installer]" value="no"{if $userinfo.software_installer eq "no"} checked="checked"{/if} /></td>
  <td><label for="software_installer_no">{$lng.lbl_no}</label></td>
</tr>
