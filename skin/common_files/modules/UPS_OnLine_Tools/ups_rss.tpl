{*
07f3f09431f1747ff6057acc275823caa01a311f, v5 (xcart_4_7_7), 2016-08-24 19:20:46, ups_rss.tpl, aim
...
function switchUPSDim(s) {
  s.form.dim_length.disabled = s.form.dim_width.disabled = s.form.dim_height.disabled = s.options[s.selectedIndex].value != '02';
...
{include file="admin/main/shipping_package_limits.tpl" shipper_options=$shipping_options.rss shipper="UPS" _weight_symbol=$shipping_options.rss.weight_units _dimensions_symbol=$shipping_options.rss.dim_units}
...
<tr>
  ...
  <td>
    <select name="av_status" id="av_status" style="width: 200px;">
