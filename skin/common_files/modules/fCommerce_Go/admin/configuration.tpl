{*
2c150253acd7fb2a890c5731390ee95bc170d71f, v5 (xcart_4_7_6), 2016-06-09 11:04:33, configuration.tpl, aim
...
<tr>
  <td colspan="3">
    ...
    {include file="main/textarea.tpl" name="gpg_key[fb_shop_header_text]" data=$lng.txt_fb_shop_header_text cols=45 rows=12 width="100%" btn_rows=4 entity_type='fb_shop_header_text'}
  </td>
</tr>
...
<tr>
  <td colspan="3">
    ...
    {include file="main/textarea.tpl" name="gpg_key[fb_shop_header_text_liked]" data=$lng.txt_fb_shop_header_text_liked cols=45 rows=12 width="100%" btn_rows=4 entity_type='fb_shop_header_text_liked'}
  </td>
</tr>
