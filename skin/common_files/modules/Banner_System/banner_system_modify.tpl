{*
d51ba4b7b957ea05b9aa37f7944f1e91363b5dda, v10 (xcart_4_7_3), 2015-05-21 12:50:33, banner_system_modify.tpl, mixon
...
{if $type ne ''}
    ...
    <form action="banner_system.php" method="post" name="bannersform">
      ...
      <table cellpadding="3" cellspacing="1" class="data-table">
        ...
        <tr class="TableHead">
          ...
          {if $config.Banner_System.bs_display_cat_selector_in_list eq 'Y'}
        ...
        {if $config.Banner_System.bs_display_cat_selector_in_list eq 'Y'}
          {assign var="bs_colspan" value=11}
        {else}
          {assign var="bs_colspan" value=10}
        {/if}
        ...
        <tr class="valign-top-row{$banner_trcolor}">
          ...
          <td nowrap="nowrap"{if $b.status ne ''} style="background-color: {if $b.status eq 'future'}#aaf{elseif $b.status eq 'expired'}#faa{/if};"{/if}>
            {include file="main/datepicker.tpl" name="banner_data[`$bannerid`][start_date]" date=$b.start_date id="datepicker`$bannerid`_start" start_year="c-2" end_year="+5"}
          </td>

          <td nowrap="nowrap"{if $b.status ne ''} style="background-color: {if $b.status eq 'future'}#aaf{elseif $b.status eq 'expired'}#faa{/if};"{/if}>
            {include file="main/datepicker.tpl" name="banner_data[`$bannerid`][end_date]" date=$b.end_date id="datepicker`$bannerid`_end" start_year="c-2" end_year="+5"}
          </td>
        ...
        <tr>
          <td colspan="{$bs_colspan}" style="padding: 5px 0px 8px 12px;" class="{$banner_trcolor}">
  ...
  <table cellpadding="3" cellspacing="1" class="data-table">
    ...
    <tr class="valign-top-row">
      ...
      <td nowrap="nowrap">
        {include file="main/datepicker.tpl" name="start_date" start_year="c-2" end_year="+5"}
      </td>

      <td nowrap="nowrap">
        {include file="main/datepicker.tpl" name="end_date" start_year="c-2" end_year="+5"}
      </td>
    ...
    <tr>
      ...
      <td colspan="{if $config.Banner_System.bs_display_cat_selector_in_list eq 'Y'}9{else}8{/if}">
