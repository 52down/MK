{*
1871834f6ef2d89e7f6dc592b4714a9440f93eb5, v13 (xcart_4_7_7), 2017-01-03 11:43:58, cc_gge4_hc.tpl, aim
...
<tr>
<td>{$lng.lbl_cc_exct_valid_referrer_url}:</td>
<td>{if $config.Security.use_https_login eq 'Y'}{$https_location}{else}{$http_location}{/if}/payment/cc_gge4_hc.php</td>
</tr>
<tr>
<td>{$lng.lbl_cc_exct_relay_url}:</td>
<td>{if $config.Security.use_https_login eq 'Y'}{$https_location}{else}{$http_location}{/if}/payment/cc_gge4_hc.php</td>
</tr>
<tr>
<td>{$lng.lbl_cc_exct_login}:</td>
<td><input type="text" name="param01" size="24" value="{$module_data.param01|escape}" /></td>
</tr>
<tr>
<td>{$lng.lbl_cc_exct_trans_key}:</td>
<td><input type="text" name="param02" size="24" value="{$module_data.param02|escape}" /></td>
</tr>
<tr>
<td>{$lng.lbl_cc_exct_timestamp_offset}:</td>
...
<option value="BYN"{if $module_data.param05 eq "BYN"} selected="selected"{/if}>Belarusian Ruble (Belarus)</option>
...
<option value="ZMW"{if $module_data.param05 eq "ZMW"} selected="selected"{/if}>Kwacha (Zambia)</option>
...
<option value="PEN"{if $module_data.param05 eq "PEN"} selected="selected"{/if}>Sol (Peru)</option>
