{*
259b8fc3048111359efbe8d111991c4bec002d24, v5 (xcart_4_7_6), 2016-03-04 16:24:12, cc_worldpay.tpl, aim
...
<tr>
  ...
  <td>
    <select name="param02">
      <option value="ARS"{if $module_data.param02 eq 'ARS'} selected="selected"{/if}>Argentine Peso</option>
...
<tr>
  ...
  <td><input type="text" name="param06" size="32" maxlength="32" value="{$module_data.param06|escape}" /></td>
</tr>
