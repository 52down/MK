{*
c5872b62b5948c040023fcc91148a8c6d9c6563a, v2 (xcart_4_7_5), 2015-12-15 09:32:05, cc_sagepay_frm.tpl, aim

vim: set ts=2 sw=2 sts=2 et:
*}
<h1>{$module_data.module_name}</h1>

<img src="{$ImagesDir}/sage_pay.jpg" width="150" height="70" alt="Sage Pay logo" align="right" style="padding-left: 10px;" />
{$lng.txt_cc_configure_top_text}
<br /><br />
<input type="button" name="sagepay_signup" value="{$lng.lbl_cc_sagepay_signup}" onclick="javascript: window.open('https://support.sagepay.com/apply/default.aspx?PartnerID=653E8C42-AD93-4654-BB91-C645678FA97B');" />
<br /><br />
...
<tr>
<td>{$lng.lbl_cc_sagepay_vendorname}:</td>
<td><input type="text" name="param01" size="32" value="{$module_data.param01|escape}" /></td>
</tr>
<tr>
<td>{$lng.lbl_cc_sagepay_password}:</td>
...
<tr>
<td>{$lng.lbl_cc_sagepay_avscv2}:</td>
<td>
<select name="param06">
...
<tr>
<td>{$lng.lbl_cc_sagepay_3dsecure}:</td>
<td>
<select name="param07">
...
{$lng.lbl_cc_sagepay_ordpref_note}
</td>
</tr>
</table>
<br />
