{*
194626627da00f55901e393daa481ee1a5d33cfb, v13 (xcart_4_7_4), 2015-10-26 13:19:01, cc_fdg_connect.tpl, aim
...
<tr>
  ...
  <td>
    <input type="text" name="param03" size="32" value="{$module_data.param03|escape}" /><br />
    {$lng.txt_fdg_connect_account_note}
  </td>
</tr>
