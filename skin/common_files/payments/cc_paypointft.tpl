{*
33a5d147bed24eb5923a591abbb371ca6a0146eb, v7 (xcart_4_7_6), 2016-03-07 18:30:44, cc_paypointft.tpl, aim
...
<option{if $module_data.param02 eq "MWK"} selected="selected"{/if} value="MWK">Malawi Kwacha</option>
...
<option{if $module_data.param02 eq "PEN"} selected="selected"{/if} value="PEN">Sol</option>
...
<option{if $module_data.param02 eq "RUB"} selected="selected"{/if} value="RUB">Russian Ruble</option>
...
<option{if $module_data.param02 eq "ZMW"} selected="selected"{/if} value="ZMW">Zambian Kwacha</option>
