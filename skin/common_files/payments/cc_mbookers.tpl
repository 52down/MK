{*
26b8d2c97587fa58b79025ebcae5616fc98dbf50, v4 (xcart_4_7_6), 2016-05-20 12:11:27, cc_mbookers.tpl, aim

vim: set ts=2 sw=2 sts=2 et:
*}
<h1>{$module_data.module_name}</h1>
<p>
  <a href="https://content.skrill.com/en/ecommerce-solutions/xcart/" target="_blank"><img style="padding-left: 10px;" align="right" src="{$ImagesDir}/payments/skrill_payment_logo_120x40_en.jpg" width="120" height="40" border="0" alt="Skrill logo" /></a>
