{*
33a5d147bed24eb5923a591abbb371ca6a0146eb, v7 (xcart_4_7_6), 2016-03-07 18:30:44, cc_ogoneweb.tpl, aim
...
<td>{if $config.Security.use_https_login eq 'Y'}{$https_location}{else}{$http_location}{/if}/payment/cc_ogoneweb_result.php</td>
</tr>
<tr>
...
<option value="RUB"{if $module_data.param04 eq "RUB"} selected="selected"{/if}>Russian Ruble</option>
