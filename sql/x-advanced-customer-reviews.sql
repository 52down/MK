...
ALTER TABLE xcart_product_reviews ADD is_coupon_sent binary(1) NOT NULL default 'N' AFTER is_verified;
...
REPLACE INTO xcart_config SET name='acr_reward_coupon_discount', comment='Reward coupon discount', value='0', category='Advanced_Customer_Reviews', orderby='452', type='numeric', defvalue='0', variants='', validation='';
REPLACE INTO xcart_config SET name='acr_reward_coupon_type', comment='Reward coupon discount type', value='A', category='Advanced_Customer_Reviews', orderby='454', type='selector', defvalue='A', variants='P:lbl_percent\r\nA:lbl_absolute', validation='';
