CREATE TABLE `xcart_product_notifications` (
	...
	`type` binary(1) NOT NULL default 'B' COMMENT 'Use func_binary_empty',
	`productid` int(11) NOT NULL default '0',
	`variantid` int(11) NOT NULL default '0',
	`email` varchar(128) NOT NULL default '',
	`userid` int(11) NOT NULL default '0',
	`date` int(11) NOT NULL default '0',
	`extra` blob NOT NULL COMMENT 'binary-safe blob is used to avoid data corruption with php unserialize function',
