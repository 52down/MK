...
CREATE TABLE xcart_banners_categories (
  ...
  PRIMARY KEY (categoryid,bannerid),
...
INSERT INTO xcart_config SET name='bs_display_cat_selector_in_list', comment='Display category selector in the banner list', value='Y', category='Banner_System', orderby='1100', type='checkbox', defvalue='Y', variants='', validation='';
...
INSERT INTO xcart_config SET name='sep_bs_admin_sets', comment='Admin back end settings', value='Y', category='Banner_System', orderby='1000', type='separator', defvalue='Y', variants='', validation='';
INSERT INTO xcart_config SET name='sep_bs_customer_sets', comment='Storefront settings', value='', category='Banner_System', orderby='1', type='separator', defvalue='', variants='', validation='';
