...
REPLACE INTO xcart_config SET name='show_products_for_last_n_days', comment='Show products added in the last N days', value='7', category='New_Arrivals', orderby='20', type='numeric', defvalue='7', variants='', validation='';
...
REPLACE INTO xcart_config SET name='on_sale_on_manufacturers_page', comment='On the Manufacturers page', value='N', category='On_Sale', orderby='230', type='checkbox', defvalue='', variants='', validation='';
