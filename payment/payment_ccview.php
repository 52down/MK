 ...
 * @version    0b0633768559e57d1124488556a9dbf71d865723, v42 (xcart_4_7_7), 2017-01-23 20:12:10, payment_ccview.php, aim
...
$a = func_query_first("SELECT param1,param2,param3,param4,param5,param6,param7,param8,param9,sessid,trstat,is_callback,cart_state FROM $sql_tbl[cc_pp3_data] WHERE ref='" . $skey . "'");
...
if ($a['is_callback'] != 'N') {
    ...
    // it seems callback was succesfull, so clear cart
    $cart = '';
}
...
func_unset($a, 'is_callback', 'sessid', 'trstat', 'cart_state');
$url = implode('', $a);
